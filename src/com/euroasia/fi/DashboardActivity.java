...
public class DashboardActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		share.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
				...
				i.putExtra(Intent.EXTRA_SUBJECT, "Tsekkaa tämä sovellus");
				i.putExtra(Intent.EXTRA_TEXT, "Mukanaan tehokas hakutoiminto, "+getString(R.string.app_name)+" tarjoaa miljoonia laadukkaita kappaleita. Voit joko nauttia niistä verkossa tai ladata niitä ilmaiseksi. Koe kuuloaistin juhla nyt! "+getString(R.string.app_name)+" Download Link: https://market.android.com/details?id="+getString(R.string.market_url));
		...
		if(!isInternetConnectionActive(getApplicationContext())) {
			...
			builder.setMessage("Tarvitset aktiivisen Internet-yhteyden voidaksesi käyttää sovelluksen useimpia ominaisuuksia. Ole hyvä ja mene omiin asetuksiisi ja ota käyttöön wifi!")
				   .setCancelable(false)
	...
	public void rateapp(){		
		...
		if(hasBeenShown == false){
			...
			String message = "Arvoisat käyttäjät, jos pidätte sovelluksestamme, annattehan meille 5 tähteä. Jatkuva tukenne on parannustemme perusta.";
 
			AlertDialog.Builder builder = new AlertDialog.Builder(this)
					.setTitle(title)
					.setMessage(message)
					.setPositiveButton("Äänestä", new Dialog.OnClickListener() {
