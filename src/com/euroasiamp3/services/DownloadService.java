...
import com.euroasia.fi.DownloadingActivity;
import com.euroasia.fi.R;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("Lataus peruttu","Peruttu: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("Lataus epŠonnistui","EpŠonnistui: "+filename,filename); 
				http--;
				...
				regularNotif("Lataus on valmis","Valmis: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "Klikkaa tŠstŠ ja nŠe eteneminen", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
